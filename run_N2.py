...
for i,u in enumerate(U0):
    print("Simulating empty_GCMC_N2 with background energy {}".format(u))
    # sp.call([r"./empty_GCMC_N2.exe","{}".format(u),"{}".format(20000)])
    dataFile = pd.read_csv(r"./results_empty_box_N2/SIM_U{:.2f}.txt".format(u),sep=',',header=2)
